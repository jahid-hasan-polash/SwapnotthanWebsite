...
<head>
	<title>Swapnotthan || A voluntary Organization of SUST </title>
	<meta charset="utf-8">
					...
					<div class="menu_block ">
						...
						<nav class="horizontal-nav full-width horizontalNav-notprocessed">
							<ul class="sf-menu">
								...
								<li><a href="getinvolve.html">Get Involved</a></li>
				...
				<div class="iosSlider">
					<div class="slider">
						<div class="item item1">
							<div class="inner">
								<div class="text1"><span> দ্বীপ শিখা হাতে স্বপ্নের পথে...... </span></div>
							</div>
						</div>
		...
		<div class="content"><div class="ic"></div>
			...
			<div class="container_12">
				<div class="grid_3">
					...
					<ul class="list">
						<li>
							<time datetime="2014-12-12">12<span>Dec</span></time>
							<div class="extra_wrapper">
								<div class="title col2"><a href="">Website</a></div>
								Swapnotthan
								website launched
							</div>
					<!--	</li>
					...
					<section>
						<ul id="da-thumbs" class="da-thumbs">
							<li>
								...
								<div><span>Blood Donation</span></div>
								</a>
							</li>
							<li>
								<a href="#">
							...
							<li>
								...
								<div><span>Chotomoni Nibas</span></div>
								</a>
							</li>
							<li>
								<a href="#">
								<img src="images/th4.jpg" alt="" />
								<div><span>Helping Helpless</span></div>
								</a>
							</li>
							<li>
								<a href="#">
							...
							<li>
								...
								<div><span>Cancer Donation</span></div>
								</a>
							</li>
						</ul>
					</section>
			...
			<div class="container_12">
				...
				<div class="grid_5 prefix_3">
					...
					<div class="socials">
						...
						<a href="https://www.facebook.com/swapnotthan"><div class="fa fa-facebook"></div></a>
...
<!--==============================footer=================================-->
		<footer>
			<div class="container_12">
				<div class="grid_12">
					<div class="copy">
						Swapnotthan &copy; 2014 | <a href="#">Privacy Policy</a> <br> Website developed by <a href="scdnlab.com" rel="nofollow">SCDN Lab</a> & <br><a href="#" target="_blank">Team, </a>Dept of CSE, SUST.
					</div>
				</div>
			</div>
		</footer>
