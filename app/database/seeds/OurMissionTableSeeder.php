...
class OurMissionTableSeeder extends Seeder {
	...
	{
		$description = [
								'preview' => "It is the small try of SUST student to achive a big dream. Our aim is to motivate the students to do something positive worthwhile and constructive for themselves and rest of the society...",
